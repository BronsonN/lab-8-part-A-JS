...
function registerListeners() {
  ...
  //  RetrieveHTMLPageWithClear('carpic1', 'exner.html', false);
    ...
    var imgElement = document.getElementById("carpic1");
    if (imgElement) {
        imgElement.addEventListener("mouseover", function () { getContent("image1.html"); }, false);
        imgElement.addEventListener("mouseout", clearContent, false);
    }
    else {
        console.log("Could not find element 'carpic1'");
    }
    ...
    RetrieveHTMLPageWithClear('carpic2', 'shelbydaytona.html', false);
    ...
    RetrieveHTMLPageWithClear('carpic3', 'countach.html', false);
    ...
    RetrieveHTMLPageWithClearAdvanced("demoLab8PartA-img1");
    RetrieveHTMLPageWithClearAdvanced("demoLab8PartA-img2");
    RetrieveHTMLPageWithClearAdvanced("demoLab8PartA-img3");
    RetrieveHTMLPageWithClearAdvanced("demoLab8PartA-img4");
    RetrieveHTMLPageWithClearAdvanced("demoLab8PartA-img5");
    RetrieveHTMLPageWithClearAdvanced("demoLab8PartA-img6");
    RetrieveHTMLPageWithClearAdvanced("demoLab8PartA-img7");
    RetrieveHTMLPageWithClearAdvanced("demoLab8PartA-img8");
...
function getContent(infopage) {
    ...
    asynchrequest.onreadystatechange = function () {
        ...
        if (asynchrequest.readyState == 4 && asynchrequest.status == 200) {
            ...
            var updateElement = document.getElementById("pictures");
            if (updateElement && updateElement.innerHTML !== undefined) {
                ...
                ToggleClassState('pictures','hidden',false);
            }
            else {
